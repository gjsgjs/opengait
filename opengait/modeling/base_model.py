...
class BaseModel(MetaModel, nn.Module):
    ...
    def get_data(self):
        self.data_source = load_data(os.path.basename(self.cfgs['data_cfg']['dataset_r'])
                                     , 64, None, cache=False)
    ...
    def run_train(model):
        ...
        for inputs in tqdm(model.train_loader, total=model.engine_cfg['total_iter'] - model.iteration):
            ...
            with autocast(enabled=model.engine_cfg['enable_float16']):
                ...
                del retval
                # training_feat['triplet']['embeddings'] feature [16, 256, 62]
                # training_feat['triplet']['labels'] 标签
    ...
    def run_infer(model):
        ...
        for x in tqdm(data_loader):
            ...
            ##
            retval = model(ipts)
            feature = retval['training_feat']['triplet']['embeddings']
