...
parser.add_argument('--phase', default='train',
                    choices=['train', 'test', 'infer'], help="choose train or test phase")
...
def run_model(cfgs, training, infering):
    msg_mgr = get_msg_mgr()
...
if __name__ == '__main__':
    ...
    infering = (opt.phase == 'infer')
    initialization(cfgs, training)
    run_model(cfgs, training, infering)
